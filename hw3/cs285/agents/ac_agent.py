...
class ACAgent(BaseAgent):
    ...
    def train(self, ob_no, ac_na, re_n, next_ob_no, terminal_n):
        ...
        for i in range(self.agent_params['num_critic_updates_per_agent_update']):
            c_loss = self.critic.update(ob_no, next_ob_no, re_n, terminal_n)[1]
        ...
        loss = OrderedDict()
        loss['Critic_Loss'] = c_loss  # put final critic loss here
        loss['Actor_Loss'] = a_loss  # put final actor loss here
        return loss
